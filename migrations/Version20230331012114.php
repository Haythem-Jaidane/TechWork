 ...
 */
final class Version20230331012114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id VARCHAR(255) NOT NULL, id_tuteur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL, duree INT NOT NULL, date_de_lancement DATETIME NOT NULL, INDEX IDX_FDCA8C9C6D9D4FF (id_tuteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
