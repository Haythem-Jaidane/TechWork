 ...
 * @author Karim
 */
public class RecruteurEditOffreController implements Initializable {
    ...
    private ChoiceBox<String> cbStatus;
        private String[] status ={"Disponible","Plus Disponible"};
...
//        cbContrat.setValue(null); 
      //  cbDomaine.setValue(null); 
        ...
        tfNom.setText(nomRecruteur);
                tfMail.setText(emailRecruteur);
    } 
     ...
     ServiceOffre s = new ServiceOffre();
      ...
      String h = cbContrat.getValue();
        s.modifier(new Offre( Integer.parseInt(tfId.getText()),tfTitle.getText(),tfDesc.getText(),
                ...
                cbStatus.getValue(),cbDomaine.getValue(),tfNom.getText(),tfMail.getText()));
