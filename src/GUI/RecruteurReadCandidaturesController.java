 ...
 * @author Karim
 */
public class RecruteurReadCandidaturesController implements Initializable {
    ...
    private void btnViewOffre() {
        try {
            ...
            s.afficherEnAttenteRecruteur(candidaturesList, candidaturesTable);
            
            candidaturesListRejected.clear();
          
            s.afficherRejectedRecruteur(candidaturesListRejected, rejectedCandidaturesTable);
            
            candidaturesListAccepted.clear();
            
            s.afficherAcceptedRecruteur(candidaturesListAccepted, acceptedCandidaturesTable);
        ...
        this.nbRejected.setText(Integer.toString(candidaturesListRejected.size()));
            ...
            Logger.getLogger(RecruteurReadCandidaturesController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("RecruteurCandidatureEdit.fxml"));
                            try {
                                loader.load();
                            } catch (IOException ex) {
                                Logger.getLogger(RecruteurReadOffresController.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            RecruteurCandidatureEditController eoc = loader.getController();
