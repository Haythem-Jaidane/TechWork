...
public class UtilisateurH {
    ...
    public UtilisateurH(String id_utilisateur, String nom, boolean isTuto) {
        this.id_utilisateur = id_utilisateur;
        this.nom = nom;
        this.isTuto = isTuto;
    }

    public UtilisateurH(String id_utilisateur, String nom) {
        this.id_utilisateur = id_utilisateur;
        this.nom = nom;
    }

    public UtilisateurH(String id_utilisateur) {
        this.id_utilisateur = id_utilisateur;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final UtilisateurH other = (UtilisateurH) obj;
