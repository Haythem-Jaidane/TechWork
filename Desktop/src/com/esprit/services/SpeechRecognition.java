...
public class SpeechRecognition {
	...
	/**
	 * This String contains the Result that is coming back from SpeechRecognition
	 */
	 ...
	 */
	private SimpleBooleanProperty SpeechRecognitionThreadRunning = new SimpleBooleanProperty(false);
	...
	public synchronized void startSpeechRecognition() {
		...
		//Check lock
		if (SpeechRecognitionThreadRunning.get())
			logger.log(Level.INFO, "Reconnaissance vocale deja en marche...\n");
		else
			...
			eventsExecutorService.submit(() -> {
				...
				//locks
				Platform.runLater(() -> {
					SpeechRecognitionThreadRunning.set(true);
				...
				//Information			
				logger.log(Level.INFO, "Dites quelque chose...\n");
				
				try {
					while (SpeechRecognitionThreadRunning.get()) {
						/*
						...
						if (!ignoreSpeechRecognitionResults.get()) {
							...
							if (speechResult == null)
								logger.log(Level.INFO, "Mafhemtekch.\n");
							else {
					...
					Platform.runLater(() -> SpeechRecognitionThreadRunning.set(false));
				}
	...
	public SimpleBooleanProperty SpeechRecognitionThreadRunningProperty() {
		return SpeechRecognitionThreadRunning;
	}
