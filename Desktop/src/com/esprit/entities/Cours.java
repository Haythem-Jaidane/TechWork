...
public class Cours {
    ...
    public Cours(String titre, int id_tuteur, String categorie, int duree) {
        this.titre = titre;
    ...
    public Cours(String id, String titre, int tuteur,String categorie) {
        this.id = id;
        this.titre = titre;
    ...
    public Cours(String id, String titre, int tuteur,String categorie, int duree, Date date_lancement) {
        this.id = id;
        this.titre = titre;
        this.id_tuteur = tuteur;
        this.categorie = categorie;
