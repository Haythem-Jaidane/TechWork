 ...
 * @author Karim
 */
public class VoiceRecognitionController extends BorderPane {//implements Initializable {
	...
	public VoiceRecognitionController() {
		...
		// FXMLLoader
		FXMLLoader loader = new FXMLLoader(getClass().getResource("VoiceRecognition.fxml"));
