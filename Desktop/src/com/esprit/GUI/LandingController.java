...
public class LandingController implements Initializable {
    ...
    private void candidat(MouseEvent event) {
       try {
            ...
            Logger.getLogger(CandidatReadOffresController.class.getName()).log(Level.ALL, null, ex);//EDITT
        }
    }
    ...
    private void recruteur(MouseEvent event) {
       try {
            ...
            Logger.getLogger(RecruteurReadOffresController.class.getName()).log(Level.SEVERE, null, ex);//EDITT
        }
    }
