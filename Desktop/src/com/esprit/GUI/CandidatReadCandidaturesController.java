...
//import atrash.ReadOffresController;
 ...
 * @author Karim
 */
public class CandidatReadCandidaturesController implements Initializable {
    ...
    private void btnViewOffre() {
        try {
            ...
            s.afficherEnAttenteCandidatures(candidaturesList, candidaturesTable);
            
            candidaturesListRejected.clear();
          
            s.afficherRejectedCandidatures(candidaturesListRejected, rejectedCandidaturesTable);
            
            candidaturesListAccepted.clear();
            
            s.afficherAcceptedCandidatures(candidaturesListAccepted, acceptedCandidaturesTable);
        ...
        this.nbRejected.setText(Integer.toString(candidaturesListRejected.size()));
            ...
            Logger.getLogger(CandidatReadCandidaturesController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
