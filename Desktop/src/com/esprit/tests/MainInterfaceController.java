...
public class MainInterfaceController   extends BorderPane {//implements Initializable {
	 ...
	 */
        ...
        private RecruteurReadOffresController parent;
	public MainInterfaceController(RecruteurReadOffresController aThis) {
		this.parent = aThis;
		// FXMLLoader
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/esprit/fxml/MainInterfaceController.fxml"));
 ...
 c.setLbDataa(infoArea.getText());
                      parent.sayHi("dfghfdghf");
